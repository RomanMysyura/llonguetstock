...
const createCategory = () => {
    ...
    axios.post('/api/createcategory', formData, {
        headers: {
...
<template>
    <div class="h-full w-full bg-white">
                        ...
                        <div class="md:flex">
                            <div class="w-full">
                                <div
                                    ...
                                    <input class="h-full w-full opacity-0 cursor-pointer" type="file"
        ...
        <table class="table-auto w-full mt-4 ">
            ...
            <tbody>
                <tr v-for="(category, index) in categories" :key="category.id" :class="index % 2 === 0 ? 'bg-gray-100' : 'bg-white'" class="text-center text-black">
